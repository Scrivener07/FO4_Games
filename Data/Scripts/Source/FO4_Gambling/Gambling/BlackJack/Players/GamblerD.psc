...
Event OnDeal(Deck:Card card, int index)
	If (card)
		If (card.Reference)
			If (index == 0)
				Controller.Translate(card.Reference, Gambling_BlackJack_P5C01)
			ElseIf (index == 1)
				Controller.Translate(card.Reference, Gambling_BlackJack_P5C02)
			ElseIf (index == 2)
				Controller.Translate(card.Reference, Gambling_BlackJack_P5C03)
			ElseIf (index == 3)
				Controller.Translate(card.Reference, Gambling_BlackJack_P5C04)
			ElseIf (index == 4)
				Controller.Translate(card.Reference, Gambling_BlackJack_P5C05)
			ElseIf (index == 5)
				Controller.Translate(card.Reference, Gambling_BlackJack_P5C06)
			ElseIf (index == 6)
				Controller.Translate(card.Reference, Gambling_BlackJack_P5C07)
			ElseIf (index == 7)
				Controller.Translate(card.Reference, Gambling_BlackJack_P5C08)
			ElseIf (index == 8)
				Controller.Translate(card.Reference, Gambling_BlackJack_P5C09)
			ElseIf (index == 9)
				Controller.Translate(card.Reference, Gambling_BlackJack_P5C10)
			ElseIf (index == 10)
				Controller.Translate(card.Reference, Gambling_BlackJack_P5C11)
			Else
